export function getErrorMessage(error: any, fallback: string): string {
  ...
  const codeMessageMap: Record<string, string> = {
    ...
    bot_token_required: '请选择一个可用的机器人',
    invalid_bot_token: '机器人凭证已失效，请重新选择机器人',
    bot_ownership_mismatch: '只能操作自己名下的机器人',
    bot_not_in_group: '该机器人还不在当前群里',
    bot_inactive: '目标机器人未激活',
    no_available_bot: '当前账号没有可用的机器人',
