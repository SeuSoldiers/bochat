...
/// Create a new group (only users can create groups)
...
pub async fn create_group(
    ...
    // Get the bot to find its owner (user)
    ...
    tracing::info!("Group created: {} by user {}", group_id, user_id);
...
/// List groups created by the authenticated user
#[tracing::instrument(skip(pool))]
